...
describe('session-log invariants', () => {
  ...
  it('enforces turn numbering and core execution enclosure', async () => {
    ...
    expect(() => { return open.append('turn/start', { turn: 2, trigger: { kind: 'message', source: { kind: 'user' } } }) })
    ...
    expect(() => { return second.append('turn/start', { turn: 3, trigger: { kind: 'message', source: { kind: 'user' } } }) })
