...
| `process-tree/` | Zero-dependency process-tree termination: taskkill /T on Windows, SIGTERM→SIGKILL process-group escalation on POSIX | (library — imported by dsh-desktop's kill paths) |
