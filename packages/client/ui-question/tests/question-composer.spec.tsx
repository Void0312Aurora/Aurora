...
function wait(rpcId = 'question-1', respond = vi.fn(() => { return Promise.resolve<RpcReceipt>({ accepted: true }) })) {
...
describe('QuestionComposer', () => {
  ...
  it('renders chrome copy through the English dictionary', () => {
    const respond = vi.fn(() => { return Promise.resolve<RpcReceipt>({ accepted: true }) })
    const carrier = new PendingWait(
